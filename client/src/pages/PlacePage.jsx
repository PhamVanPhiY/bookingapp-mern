        ...
        <div className="p-8 grid gap-4 bg-black">
          <div>
            ...
            <button
              ...
              className="fixed right-12 top-8 flex gap-2 px-4 py-2 rounded-2xl shadow shadow-black text-black bg-white"
            >
              <svg
  ...
  return (
    <div className="mt-4  bg-gray-100 -mx-8 px-8 pt-8">
      ...
      <div className="relative">
        ...
        <button
          onClick={() => setShowAllPhotos(true)}
          className=" flex gap-1 absolute bottom-2 right-2 py-2 px-4 bg-white rounded-2xl shadow shadow-sm shadow-gray-500 "
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
